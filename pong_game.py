...
def draw(canvas):
    ...
    canvas.draw_line([WIDTH - PAD_WIDTH, 0],[WIDTH - PAD_WIDTH, HEIGHT], 1, "White")
        ...
        #unified code for collision and testing if the ball hits the paddle
    ...
    #collision conditions top bottom
    ...
    # draw paddles
    canvas.draw_line([PAD_WIDTH / 2, paddle1_pos], [PAD_WIDTH / 2, PAD_HEIGHT + paddle1_pos], PAD_WIDTH, "White")      
    canvas.draw_line([WIDTH - PAD_WIDTH / 2, paddle2_pos],[WIDTH- PAD_WIDTH / 2, paddle2_pos + PAD_HEIGHT], PAD_WIDTH, "White")
    # determine whether paddle and ball collide    
    
    # draw scores
    canvas.draw_text(str(score1), [250,20], 24, "Red") 
    canvas.draw_text(str(score2), [350,20], 24, "Red")  
def keydown(key):
